 ...
 *
 * 座標系: 元PNGと同じ 648x907。FLIP を掛けた内側で使う（potrace のY反転ぶん）。
 *
 * 重ね方（下 → 上）:
...
export const ILLUST_FLIP = "translate(0,907) scale(0.1,-0.1)";

export const ILLUST_VIEWBOX = { w: 648, h: 907 } as const;
...
export const BROW_D = {
  left: [
    "M1940 7046 c0 -72 343 -288 375 -236 11 18 -15 40 -100 80 -51 24 -112 65 -163 109 -87 76 -112 86 -112 47z",
  ],
  right: [
    "M3390 6723 c-51 -15 -243 -19 -425 -10 -40 2 -50 -1 -53 -15 -6 -30 43 -40 223 -45 234 -8 365 17 365 69 0 22 -32 22 -110 1z",
  ],
} as const;
